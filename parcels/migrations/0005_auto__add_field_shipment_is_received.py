...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Shipment.is_received'
        db.add_column(u'parcels_shipment', 'is_received',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Shipment.is_received'
        db.delete_column(u'parcels_shipment', 'is_received')
