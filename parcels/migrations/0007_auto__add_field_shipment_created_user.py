...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Shipment.created_user'
        db.add_column(u'parcels_shipment', 'created_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Shipment.created_user'
        db.delete_column(u'parcels_shipment', 'created_user_id')
    ...
    models = {
        ...
        u'parcels.statusentry': {
            'Meta': {'ordering': "['-event_dt']", 'unique_together': "(['event_dt', 'place', 'status', 'shipment'],)", 'object_name': 'StatusEntry'},
